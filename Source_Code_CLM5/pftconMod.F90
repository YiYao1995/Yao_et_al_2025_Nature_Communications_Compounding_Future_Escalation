module pftconMod
  ...
  integer, public :: nirrig_dri_tmp_corn        ! value for temperate corn, drip irrigated (ir_1)
  integer, public :: nirrig_spr_tmp_corn        ! value for temperate corn, sprinkler irrigated (ir_2)
  integer, public :: nirrig_fld_tmp_corn        ! value for temperate corn, flood irrigated (ir_3)
  
  integer, public :: nswheat                ! value for spring temperate cereal (rf)
  integer, public :: nirrig_dri_swheat          ! value for spring temperate cereal, drip irrigated (ir_1)
  integer, public :: nirrig_spr_swheat          ! value for spring temperate cereal, sprinkler irrigated (ir_2)
  integer, public :: nirrig_fld_swheat          ! value for spring temperate cereal, flood irrigated (ir_3)
  
  integer, public :: nwwheat                ! value for winter temperate cereal (rf)
  integer, public :: nirrig_dri_wwheat          ! value for winter temperate cereal, drip irrigated (ir_1)
  integer, public :: nirrig_spr_wwheat          ! value for winter temperate cereal, sprinkler irrigated (ir_2)
  integer, public :: nirrig_fld_wwheat          ! value for winter temperate cereal, flood irrigated (ir_3)
  
  integer, public :: ntmp_soybean           ! value for temperate soybean (rf)
  integer, public :: nirrig_dri_tmp_soybean     ! value for temperate soybean, drip irrigated (ir_1)
  integer, public :: nirrig_spr_tmp_soybean     ! value for temperate soybean, sprinkler irrigated (ir_2)
  integer, public :: nirrig_fld_tmp_soybean     ! value for temperate soybean, flood irrigated (ir_3)
  
  integer, public :: nbarley                ! value for spring barley (rf)
  integer, public :: nirrig_dri_barley          ! value for spring barley (ir)
  integer, public :: nirrig_spr_barley          ! value for spring barley (ir)
  integer, public :: nirrig_fld_barley          ! value for spring barley (ir)
  
  integer, public :: nwbarley               ! value for winter barley (rf)
  integer, public :: nirrig_dri_wbarley         ! value for winter barley (ir)
  integer, public :: nirrig_spr_wbarley         ! value for winter barley (ir)
  integer, public :: nirrig_fld_wbarley         ! value for winter barley (ir)
  
  integer, public :: nrye                   ! value for spring rye (rf)
  integer, public :: nirrig_dri_rye             ! value for spring rye (ir)
  integer, public :: nirrig_spr_rye             ! value for spring rye (ir)
  integer, public :: nirrig_fld_rye             ! value for spring rye (ir)
  
  integer, public :: nwrye                  ! value for winter rye (rf)
  integer, public :: nirrig_dri_wrye            ! value for winter rye (ir)
  integer, public :: nirrig_spr_wrye            ! value for winter rye (ir)
  integer, public :: nirrig_fld_wrye            ! value for winter rye (ir)
  
  integer, public :: ncassava               ! ...and so on
  integer, public :: nirrig_dri_cassava
  integer, public :: nirrig_spr_cassava
  integer, public :: nirrig_fld_cassava
  
  integer, public :: ncitrus
  integer, public :: nirrig_dri_citrus
  integer, public :: nirrig_spr_citrus
  integer, public :: nirrig_fld_citrus
  
  integer, public :: ncocoa
  integer, public :: nirrig_dri_cocoa
  integer, public :: nirrig_spr_cocoa
  integer, public :: nirrig_fld_cocoa
  
  integer, public :: ncoffee
  integer, public :: nirrig_dri_coffee
  integer, public :: nirrig_spr_coffee
  integer, public :: nirrig_fld_coffee
  
  integer, public :: ncotton
  integer, public :: nirrig_dri_cotton
  integer, public :: nirrig_spr_cotton
  integer, public :: nirrig_fld_cotton
  
  integer, public :: ndatepalm
  integer, public :: nirrig_dri_datepalm
  integer, public :: nirrig_spr_datepalm
  integer, public :: nirrig_fld_datepalm
  
  integer, public :: nfoddergrass
  integer, public :: nirrig_dri_foddergrass
  integer, public :: nirrig_spr_foddergrass
  integer, public :: nirrig_fld_foddergrass
  
  integer, public :: ngrapes
  integer, public :: nirrig_dri_grapes
  integer, public :: nirrig_spr_grapes
  integer, public :: nirrig_fld_grapes
  
  integer, public :: ngroundnuts
  integer, public :: nirrig_dri_groundnuts
  integer, public :: nirrig_spr_groundnuts
  integer, public :: nirrig_fld_groundnuts
  
  integer, public :: nmillet
  integer, public :: nirrig_dri_millet
  integer, public :: nirrig_spr_millet
  integer, public :: nirrig_fld_millet
  
  integer, public :: noilpalm
  integer, public :: nirrig_dri_oilpalm
  integer, public :: nirrig_spr_oilpalm
  integer, public :: nirrig_fld_oilpalm
  
  integer, public :: npotatoes
  integer, public :: nirrig_dri_potatoes
  integer, public :: nirrig_spr_potatoes
  integer, public :: nirrig_fld_potatoes
  
  integer, public :: npulses
  integer, public :: nirrig_dri_pulses
  integer, public :: nirrig_spr_pulses
  integer, public :: nirrig_fld_pulses
  
  integer, public :: nrapeseed
  integer, public :: nirrig_dri_rapeseed
  integer, public :: nirrig_spr_rapeseed
  integer, public :: nirrig_fld_rapeseed
  
  integer, public :: nrice
  integer, public :: nirrig_dri_rice
  integer, public :: nirrig_spr_rice
  integer, public :: nirrig_fld_rice
  
  integer, public :: nsorghum
  integer, public :: nirrig_dri_sorghum
  integer, public :: nirrig_spr_sorghum
  integer, public :: nirrig_fld_sorghum
  
  integer, public :: nsugarbeet
  integer, public :: nirrig_dri_sugarbeet
  integer, public :: nirrig_spr_sugarbeet
  integer, public :: nirrig_fld_sugarbeet
  
  integer, public :: nsugarcane
  integer, public :: nirrig_dri_sugarcane
  integer, public :: nirrig_spr_sugarcane
  integer, public :: nirrig_fld_sugarcane
  
  integer, public :: nsunflower
  integer, public :: nirrig_dri_sunflower
  integer, public :: nirrig_spr_sunflower
  integer, public :: nirrig_fld_sunflower
  
  integer, public :: nmiscanthus
  integer, public :: nirrig_dri_miscanthus
  integer, public :: nirrig_spr_miscanthus
  integer, public :: nirrig_fld_miscanthus
  
  integer, public :: nswitchgrass
  integer, public :: nirrig_dri_switchgrass
  integer, public :: nirrig_spr_switchgrass
  integer, public :: nirrig_fld_switchgrass
  
  integer, public :: ntrp_corn              !value for tropical corn (rf)
  integer, public :: nirrig_dri_trp_corn        !value for tropical corn (ir)
  integer, public :: nirrig_spr_trp_corn        !value for tropical corn (ir)
  integer, public :: nirrig_fld_trp_corn        !value for tropical corn (ir)
  
  integer, public :: ntrp_soybean           !value for tropical soybean (rf)
  integer, public :: nirrig_dri_trp_soybean     !value for tropical soybean (ir)
  integer, public :: nirrig_spr_trp_soybean     !value for tropical soybean (ir)
  integer, public :: nirrig_fld_trp_soybean     !value for tropical soybean (ir)
  
  integer, public :: npcropmax              ! value for last prognostic crop in list
  integer, public :: nc3crop                ! value for generic crop (rf)
  integer, public :: nc3irrig_dri               ! value for irrigated generic crop (ir)
  integer, public :: nc3irrig_spr               ! value for irrigated generic crop (ir)
  integer, public :: nc3irrig_fld               ! value for irrigated generic crop (ir)
...
contains
  ...
  subroutine InitRead(this)
    ...
    expected_pftnames( 16) = 'dri_c3_irrigated                   '
    expected_pftnames( 17) = 'spr_c3_irrigated                   '
    expected_pftnames( 18) = 'fld_c3_irrigated                   '
    expected_pftnames( 19) = 'temperate_corn                     '
    expected_pftnames( 20) = 'dri_irrigated_temperate_corn       '
    expected_pftnames( 21) = 'spr_irrigated_temperate_corn       '
    expected_pftnames( 22) = 'fld_irrigated_temperate_corn       '
    expected_pftnames( 23) = 'spring_wheat                       '
    expected_pftnames( 24) = 'dri_irrigated_spring_wheat         '
    expected_pftnames( 25) = 'spr_irrigated_spring_wheat         '
    expected_pftnames( 26) = 'fld_irrigated_spring_wheat         '
    expected_pftnames( 27) = 'winter_wheat                       '
    expected_pftnames( 28) = 'dri_irrigated_winter_wheat         '
    expected_pftnames( 29) = 'spr_irrigated_winter_wheat         '
    expected_pftnames( 30) = 'fld_irrigated_winter_wheat         '
    expected_pftnames( 31) = 'temperate_soybean                  '
    expected_pftnames( 32) = 'dri_irrigated_temperate_soybean    '
    expected_pftnames( 33) = 'spr_irrigated_temperate_soybean    '
    expected_pftnames( 34) = 'fld_irrigated_temperate_soybean    '
    expected_pftnames( 35) = 'barley                             '
    expected_pftnames( 36) = 'dri_irrigated_barley               '
    expected_pftnames( 37) = 'spr_irrigated_barley               '
    expected_pftnames( 38) = 'fld_irrigated_barley               '
    expected_pftnames( 39) = 'winter_barley                      '
    expected_pftnames( 40) = 'dri_irrigated_winter_barley        '
    expected_pftnames( 41) = 'spr_irrigated_winter_barley        '
    expected_pftnames( 42) = 'fld_irrigated_winter_barley        '
    expected_pftnames( 43) = 'rye                                '
    expected_pftnames( 44) = 'dri_irrigated_rye                  '
    expected_pftnames( 45) = 'spr_irrigated_rye                  '
    expected_pftnames( 46) = 'fld_irrigated_rye                  '
    expected_pftnames( 47) = 'winter_rye                         '
    expected_pftnames( 48) = 'dri_irrigated_winter_rye           '
    expected_pftnames( 49) = 'spr_irrigated_winter_rye           '
    expected_pftnames( 50) = 'fld_irrigated_winter_rye           '
    expected_pftnames( 51) = 'cassava                            '
    expected_pftnames( 52) = 'dri_irrigated_cassava              '
    expected_pftnames( 53) = 'spr_irrigated_cassava              '
    expected_pftnames( 54) = 'fld_irrigated_cassava              '
    expected_pftnames( 55) = 'citrus                             '
    expected_pftnames( 56) = 'dri_irrigated_citrus               '
    expected_pftnames( 57) = 'spr_irrigated_citrus               '
    expected_pftnames( 58) = 'fld_irrigated_citrus               '
    expected_pftnames( 59) = 'cocoa                              '
    expected_pftnames( 60) = 'dri_irrigated_cocoa                '
    expected_pftnames( 61) = 'spr_irrigated_cocoa                '
    expected_pftnames( 62) = 'fld_irrigated_cocoa                '
    expected_pftnames( 63) = 'coffee                             '
    expected_pftnames( 64) = 'dri_irrigated_coffee               '
    expected_pftnames( 65) = 'spr_irrigated_coffee               '
    expected_pftnames( 66) = 'fld_irrigated_coffee               '
    expected_pftnames( 67) = 'cotton                             '
    expected_pftnames( 68) = 'dri_irrigated_cotton               '
    expected_pftnames( 69) = 'spr_irrigated_cotton               '
    expected_pftnames( 70) = 'fld_irrigated_cotton               '
    expected_pftnames( 71) = 'datepalm                           '
    expected_pftnames( 72) = 'dri_irrigated_datepalm             '
    expected_pftnames( 73) = 'spr_irrigated_datepalm             '
    expected_pftnames( 74) = 'fld_irrigated_datepalm             '
    expected_pftnames( 75) = 'foddergrass                        '
    expected_pftnames( 76) = 'dri_irrigated_foddergrass          '
    expected_pftnames( 77) = 'spr_irrigated_foddergrass          '
    expected_pftnames( 78) = 'fld_irrigated_foddergrass          '
	
	expected_pftnames( 79) = 'grapes                             '
    expected_pftnames( 80) = 'dri_irrigated_grapes               '
    expected_pftnames( 81) = 'spr_irrigated_grapes               '
    expected_pftnames( 82) = 'fld_irrigated_grapes               '
    expected_pftnames( 83) = 'groundnuts                         '
    expected_pftnames( 84) = 'dri_irrigated_groundnuts           '
    expected_pftnames( 85) = 'spr_irrigated_groundnuts           '
    expected_pftnames( 86) = 'fld_irrigated_groundnuts           '
    expected_pftnames( 87) = 'millet                             '
    expected_pftnames( 88) = 'dri_irrigated_millet               '
    expected_pftnames( 89) = 'spr_irrigated_millet               '
    expected_pftnames( 90) = 'fld_irrigated_millet               '
    expected_pftnames( 91) = 'oilpalm                            '
    expected_pftnames( 92) = 'dri_irrigated_oilpalm              '
    expected_pftnames( 93) = 'spr_irrigated_oilpalm              '
    expected_pftnames( 94) = 'fld_irrigated_oilpalm              '
    expected_pftnames( 95) = 'potatoes                           '
    expected_pftnames( 96) = 'dri_irrigated_potatoes             '
    expected_pftnames( 97) = 'spr_irrigated_potatoes             '
    expected_pftnames( 98) = 'fld_irrigated_potatoes             '
    expected_pftnames( 99) = 'pulses                             '
    expected_pftnames(100) = 'dri_irrigated_pulses               '
    expected_pftnames(101) = 'spr_irrigated_pulses               '
    expected_pftnames(102) = 'fld_irrigated_pulses               '
    expected_pftnames(103) = 'rapeseed                           '
    expected_pftnames(104) = 'dri_irrigated_rapeseed             '
    expected_pftnames(105) = 'spr_irrigated_rapeseed             '
    expected_pftnames(106) = 'fld_irrigated_rapeseed             '
    expected_pftnames(107) = 'rice                               '
    expected_pftnames(108) = 'dri_irrigated_rice                 '
    expected_pftnames(109) = 'spr_irrigated_rice                 '
    expected_pftnames(110) = 'fld_irrigated_rice                 '
    expected_pftnames(111) = 'sorghum                            '
    expected_pftnames(112) = 'dri_irrigated_sorghum              '
    expected_pftnames(113) = 'spr_irrigated_sorghum              '
    expected_pftnames(114) = 'fld_irrigated_sorghum              '
    expected_pftnames(115) = 'sugarbeet                          '
    expected_pftnames(116) = 'dri_irrigated_sugarbeet            '
    expected_pftnames(117) = 'spr_irrigated_sugarbeet            '
    expected_pftnames(118) = 'fld_irrigated_sugarbeet            '
    expected_pftnames(119) = 'sugarcane                          '
    expected_pftnames(120) = 'dri_irrigated_sugarcane            '
    expected_pftnames(121) = 'spr_irrigated_sugarcane            '
    expected_pftnames(122) = 'fld_irrigated_sugarcane            '
    expected_pftnames(123) = 'sunflower                          '
    expected_pftnames(124) = 'dri_irrigated_sunflower            '
    expected_pftnames(125) = 'spr_irrigated_sunflower            '
    expected_pftnames(126) = 'fld_irrigated_sunflower            '
    expected_pftnames(127) = 'miscanthus                         '
    expected_pftnames(128) = 'dri_irrigated_miscanthus           '
    expected_pftnames(129) = 'spr_irrigated_miscanthus           '
    expected_pftnames(130) = 'fld_irrigated_miscanthus           '
    expected_pftnames(131) = 'switchgrass                        '
    expected_pftnames(132) = 'dri_irrigated_switchgrass          '
    expected_pftnames(133) = 'spr_irrigated_switchgrass          '
    expected_pftnames(134) = 'fld_irrigated_switchgrass          '
    expected_pftnames(135) = 'tropical_corn                      '
    expected_pftnames(136) = 'dri_irrigated_tropical_corn        '
    expected_pftnames(137) = 'spr_irrigated_tropical_corn        '
    expected_pftnames(138) = 'fld_irrigated_tropical_corn        '
    expected_pftnames(139) = 'tropical_soybean                   '
    expected_pftnames(140) = 'dri_irrigated_tropical_soybean     '
    expected_pftnames(141) = 'spr_irrigated_tropical_soybean     '
    expected_pftnames(142) = 'fld_irrigated_tropical_soybean     '
    ...
    do i = 0, mxpft
       ...
       if ( trim(pftname(i)) == 'dri_c3_irrigated'                    ) nc3irrig_dri             = i
       if ( trim(pftname(i)) == 'temperate_corn'                      ) ntmp_corn            = i
       if ( trim(pftname(i)) == 'dri_irrigated_temperate_corn'        ) nirrig_dri_tmp_corn      = i
       if ( trim(pftname(i)) == 'spring_wheat'                        ) nswheat              = i
       if ( trim(pftname(i)) == 'dri_irrigated_spring_wheat'          ) nirrig_dri_swheat        = i
       if ( trim(pftname(i)) == 'winter_wheat'                        ) nwwheat              = i
       if ( trim(pftname(i)) == 'dri_irrigated_winter_wheat'          ) nirrig_dri_wwheat        = i
       if ( trim(pftname(i)) == 'temperate_soybean'                   ) ntmp_soybean         = i
       if ( trim(pftname(i)) == 'dri_irrigated_temperate_soybean'     ) nirrig_dri_tmp_soybean   = i
       if ( trim(pftname(i)) == 'barley'                              ) nbarley              = i
       if ( trim(pftname(i)) == 'dri_irrigated_barley'                ) nirrig_dri_barley        = i
       if ( trim(pftname(i)) == 'winter_barley'                       ) nwbarley             = i
       if ( trim(pftname(i)) == 'dri_irrigated_winter_barley'         ) nirrig_dri_wbarley       = i
       if ( trim(pftname(i)) == 'rye'                                 ) nrye                 = i
       if ( trim(pftname(i)) == 'dri_irrigated_rye'                   ) nirrig_dri_rye           = i
       if ( trim(pftname(i)) == 'winter_rye'                          ) nwrye                = i
       if ( trim(pftname(i)) == 'dri_irrigated_winter_rye'            ) nirrig_dri_wrye          = i
       if ( trim(pftname(i)) == 'cassava'                             ) ncassava             = i
       if ( trim(pftname(i)) == 'dri_irrigated_cassava'               ) nirrig_dri_cassava       = i
       if ( trim(pftname(i)) == 'citrus'                              ) ncitrus              = i
       if ( trim(pftname(i)) == 'dri_irrigated_citrus'                ) nirrig_dri_citrus        = i
       if ( trim(pftname(i)) == 'cocoa'                               ) ncocoa               = i
       if ( trim(pftname(i)) == 'dri_irrigated_cocoa'                 ) nirrig_dri_cocoa         = i
       if ( trim(pftname(i)) == 'coffee'                              ) ncoffee              = i
       if ( trim(pftname(i)) == 'dri_irrigated_coffee'                ) nirrig_dri_coffee        = i
       if ( trim(pftname(i)) == 'cotton'                              ) ncotton              = i
       if ( trim(pftname(i)) == 'dri_irrigated_cotton'                ) nirrig_dri_cotton        = i
       if ( trim(pftname(i)) == 'datepalm'                            ) ndatepalm            = i
       if ( trim(pftname(i)) == 'dri_irrigated_datepalm'              ) nirrig_dri_datepalm      = i
       if ( trim(pftname(i)) == 'foddergrass'                         ) nfoddergrass         = i
       if ( trim(pftname(i)) == 'dri_irrigated_foddergrass'           ) nirrig_dri_foddergrass   = i
       if ( trim(pftname(i)) == 'grapes'                              ) ngrapes              = i
       if ( trim(pftname(i)) == 'dri_irrigated_grapes'                ) nirrig_dri_grapes        = i
       if ( trim(pftname(i)) == 'groundnuts'                          ) ngroundnuts          = i
       if ( trim(pftname(i)) == 'dri_irrigated_groundnuts'                ) nirrig_dri_groundnuts    = i
       if ( trim(pftname(i)) == 'millet'                              ) nmillet              = i
       if ( trim(pftname(i)) == 'dri_irrigated_millet'                    ) nirrig_dri_millet        = i
       if ( trim(pftname(i)) == 'oilpalm'                             ) noilpalm             = i
       if ( trim(pftname(i)) == 'dri_irrigated_oilpalm'                   ) nirrig_dri_oilpalm       = i
       if ( trim(pftname(i)) == 'potatoes'                            ) npotatoes            = i
       if ( trim(pftname(i)) == 'dri_irrigated_potatoes'                  ) nirrig_dri_potatoes      = i
       if ( trim(pftname(i)) == 'pulses'                              ) npulses              = i
       if ( trim(pftname(i)) == 'dri_irrigated_pulses'                    ) nirrig_dri_pulses        = i
       if ( trim(pftname(i)) == 'rapeseed'                            ) nrapeseed            = i
       if ( trim(pftname(i)) == 'dri_irrigated_rapeseed'                  ) nirrig_dri_rapeseed      = i
       if ( trim(pftname(i)) == 'rice'                                ) nrice                = i
       if ( trim(pftname(i)) == 'dri_irrigated_rice'                      ) nirrig_dri_rice          = i
       if ( trim(pftname(i)) == 'sorghum'                             ) nsorghum             = i
       if ( trim(pftname(i)) == 'dri_irrigated_sorghum'                   ) nirrig_dri_sorghum       = i
       if ( trim(pftname(i)) == 'sugarbeet'                           ) nsugarbeet           = i
       if ( trim(pftname(i)) == 'dri_irrigated_sugarbeet'                 ) nirrig_dri_sugarbeet     = i
       if ( trim(pftname(i)) == 'sugarcane'                           ) nsugarcane           = i
       if ( trim(pftname(i)) == 'dri_irrigated_sugarcane'                 ) nirrig_dri_sugarcane     = i
       if ( trim(pftname(i)) == 'sunflower'                           ) nsunflower           = i
       if ( trim(pftname(i)) == 'dri_irrigated_sunflower'                 ) nirrig_dri_sunflower     = i
       if ( trim(pftname(i)) == 'miscanthus'                          ) nmiscanthus          = i
       if ( trim(pftname(i)) == 'dri_irrigated_miscanthus'                ) nirrig_dri_miscanthus    = i
       if ( trim(pftname(i)) == 'switchgrass'                         ) nswitchgrass         = i
       if ( trim(pftname(i)) == 'dri_irrigated_switchgrass'               ) nirrig_dri_switchgrass   = i
       if ( trim(pftname(i)) == 'tropical_corn'                       ) ntrp_corn            = i
       if ( trim(pftname(i)) == 'dri_irrigated_tropical_corn'             ) nirrig_dri_trp_corn      = i
       if ( trim(pftname(i)) == 'tropical_soybean'                    ) ntrp_soybean         = i
       if ( trim(pftname(i)) == 'dri_irrigated_tropical_soybean'          ) nirrig_dri_trp_soybean   = i
	   
	   if ( trim(pftname(i)) == 'spr_c3_irrigated'                             ) nc3irrig_spr              = i
       if ( trim(pftname(i)) == 'fld_c3_irrigated'                        ) nc3irrig_fld             = i
       if ( trim(pftname(i)) == 'spr_irrigated_temperate_corn'                      ) nirrig_spr_tmp_corn            = i
       if ( trim(pftname(i)) == 'fld_irrigated_temperate_corn'            ) nirrig_fld_tmp_corn      = i
       if ( trim(pftname(i)) == 'spr_irrigated_spring_wheat'                        ) nirrig_spr_swheat              = i
       if ( trim(pftname(i)) == 'fld_irrigated_spring_wheat'              ) nirrig_fld_swheat        = i
       if ( trim(pftname(i)) == 'spr_irrigated_winter_wheat'                        ) nirrig_spr_wwheat              = i
       if ( trim(pftname(i)) == 'fld_irrigated_winter_wheat'              ) nirrig_fld_wwheat        = i
       if ( trim(pftname(i)) == 'spr_irrigated_temperate_soybean'                   ) nirrig_spr_tmp_soybean         = i
       if ( trim(pftname(i)) == 'fld_irrigated_temperate_soybean'         ) nirrig_fld_tmp_soybean   = i
       if ( trim(pftname(i)) == 'spr_irrigated_barley'                              ) nirrig_spr_barley              = i
       if ( trim(pftname(i)) == 'fld_irrigated_barley'                    ) nirrig_fld_barley        = i
       if ( trim(pftname(i)) == 'spr_irrigated_winter_barley'                       ) nirrig_spr_wbarley             = i
       if ( trim(pftname(i)) == 'fld_irrigated_winter_barley'             ) nirrig_fld_wbarley       = i
       if ( trim(pftname(i)) == 'spr_irrigated_rye'                                 ) nirrig_spr_rye                 = i
       if ( trim(pftname(i)) == 'fld_irrigated_rye'                       ) nirrig_fld_rye           = i
       if ( trim(pftname(i)) == 'spr_irrigated_winter_rye'                          ) nirrig_spr_wrye                = i
       if ( trim(pftname(i)) == 'fld_irrigated_winter_rye'                ) nirrig_fld_wrye          = i
       if ( trim(pftname(i)) == 'spr_irrigated_cassava'                             ) nirrig_spr_cassava             = i
       if ( trim(pftname(i)) == 'fld_irrigated_cassava'                   ) nirrig_fld_cassava       = i
       if ( trim(pftname(i)) == 'spr_irrigated_citrus'                              ) nirrig_spr_citrus              = i
       if ( trim(pftname(i)) == 'fld_irrigated_citrus'                    ) nirrig_fld_citrus        = i
       if ( trim(pftname(i)) == 'spr_irrigated_cocoa'                               ) nirrig_spr_cocoa               = i
       if ( trim(pftname(i)) == 'fld_irrigated_cocoa'                     ) nirrig_fld_cocoa         = i
       if ( trim(pftname(i)) == 'spr_irrigated_coffee'                              ) nirrig_spr_coffee              = i
       if ( trim(pftname(i)) == 'fld_irrigated_coffee'                    ) nirrig_fld_coffee        = i
       if ( trim(pftname(i)) == 'spr_irrigated_cotton'                              ) nirrig_spr_cotton              = i
       if ( trim(pftname(i)) == 'fld_irrigated_cotton'                    ) nirrig_fld_cotton        = i
       if ( trim(pftname(i)) == 'spr_irrigated_datepalm'                            ) nirrig_spr_datepalm            = i
       if ( trim(pftname(i)) == 'fld_irrigated_datepalm'                  ) nirrig_fld_datepalm      = i
       if ( trim(pftname(i)) == 'spr_irrigated_foddergrass'                         ) nirrig_spr_foddergrass         = i
       if ( trim(pftname(i)) == 'fld_irrigated_foddergrass'               ) nirrig_fld_foddergrass   = i
       if ( trim(pftname(i)) == 'spr_irrigated_grapes'                              ) nirrig_spr_grapes              = i
       if ( trim(pftname(i)) == 'fld_irrigated_grapes'                    ) nirrig_fld_grapes        = i
       if ( trim(pftname(i)) == 'spr_irrigated_groundnuts'                          ) nirrig_spr_groundnuts          = i
       if ( trim(pftname(i)) == 'fld_irrigated_groundnuts'                ) nirrig_fld_groundnuts    = i
       if ( trim(pftname(i)) == 'spr_irrigated_millet'                              ) nirrig_spr_millet              = i
       if ( trim(pftname(i)) == 'fld_irrigated_millet'                    ) nirrig_fld_millet        = i
       if ( trim(pftname(i)) == 'spr_irrigated_oilpalm'                             ) nirrig_spr_oilpalm             = i
       if ( trim(pftname(i)) == 'fld_irrigated_oilpalm'                   ) nirrig_fld_oilpalm       = i
       if ( trim(pftname(i)) == 'spr_irrigated_potatoes'                            ) nirrig_spr_potatoes            = i
       if ( trim(pftname(i)) == 'fld_irrigated_potatoes'                  ) nirrig_fld_potatoes      = i
       if ( trim(pftname(i)) == 'spr_irrigated_pulses'                              ) nirrig_spr_pulses              = i
       if ( trim(pftname(i)) == 'fld_irrigated_pulses'                    ) nirrig_fld_pulses        = i
       if ( trim(pftname(i)) == 'spr_irrigated_rapeseed'                            ) nirrig_spr_rapeseed            = i
       if ( trim(pftname(i)) == 'fld_irrigated_rapeseed'                  ) nirrig_fld_rapeseed      = i
       if ( trim(pftname(i)) == 'spr_irrigated_rice'                                ) nirrig_spr_rice                = i
       if ( trim(pftname(i)) == 'fld_irrigated_rice'                      ) nirrig_fld_rice          = i
       if ( trim(pftname(i)) == 'spr_irrigated_sorghum'                             ) nirrig_spr_sorghum             = i
       if ( trim(pftname(i)) == 'fld_irrigated_sorghum'                   ) nirrig_fld_sorghum       = i
       if ( trim(pftname(i)) == 'spr_irrigated_sugarbeet'                           ) nirrig_spr_sugarbeet           = i
       if ( trim(pftname(i)) == 'fld_irrigated_sugarbeet'                 ) nirrig_fld_sugarbeet     = i
       if ( trim(pftname(i)) == 'spr_irrigated_sugarcane'                           ) nirrig_spr_sugarcane           = i
       if ( trim(pftname(i)) == 'fld_irrigated_sugarcane'                 ) nirrig_fld_sugarcane     = i
       if ( trim(pftname(i)) == 'spr_irrigated_sunflower'                           ) nirrig_spr_sunflower           = i
       if ( trim(pftname(i)) == 'fld_irrigated_sunflower'                 ) nirrig_fld_sunflower     = i
       if ( trim(pftname(i)) == 'spr_irrigated_miscanthus'                          ) nirrig_spr_miscanthus          = i
       if ( trim(pftname(i)) == 'fld_irrigated_miscanthus'                ) nirrig_fld_miscanthus    = i
       if ( trim(pftname(i)) == 'spr_irrigated_switchgrass'                         ) nirrig_spr_switchgrass         = i
       if ( trim(pftname(i)) == 'fld_irrigated_switchgrass'               ) nirrig_fld_switchgrass   = i
       if ( trim(pftname(i)) == 'spr_irrigated_tropical_corn'                       ) nirrig_spr_trp_corn            = i
       if ( trim(pftname(i)) == 'fld_irrigated_tropical_corn'             ) nirrig_fld_trp_corn      = i
       if ( trim(pftname(i)) == 'spr_irrigated_tropical_soybean'                    ) nirrig_spr_trp_soybean         = i
       if ( trim(pftname(i)) == 'fld_irrigated_tropical_soybean'          ) nirrig_fld_trp_soybean   = i
    end do
    ...
    if ( .not. use_crop )then
       do i = npcropmin, ntrp_soybean, 4
         this%mergetoclmpft(i) = nc3crop
       end do
       do i = nirrig_dri_tmp_corn, nirrig_dri_trp_soybean, 4
         this%mergetoclmpft(i) = nc3irrig_dri
       end do
	   do i = nirrig_spr_tmp_corn, nirrig_spr_trp_soybean, 4
         this%mergetoclmpft(i) = nc3irrig_spr
       end do
	   do i = nirrig_fld_tmp_corn, nirrig_fld_trp_soybean, 4
         this%mergetoclmpft(i) = nc3irrig_fld
       end do
    end if
    !
    ...
    if( .not. use_fates ) then
       ...
       do i = 0, mxpft
          if ( this%irrigated(i) == 1.0_r8 .and.                              &
               (i == nc3irrig_dri               .or.                              &
                i == nirrig_dri_tmp_corn        .or.                              &
                i == nirrig_dri_swheat          .or. i == nirrig_dri_wwheat      .or. &
                i == nirrig_dri_tmp_soybean     .or.                              &
                i == nirrig_dri_barley          .or. i == nirrig_dri_wbarley     .or. &
                i == nirrig_dri_rye             .or. i == nirrig_dri_wrye        .or. &
                i == nirrig_dri_cassava         .or.                              &
                i == nirrig_dri_citrus          .or.                              &
                i == nirrig_dri_cocoa           .or. i == nirrig_dri_coffee      .or. &
                i == nirrig_dri_cotton          .or.                              &
                i == nirrig_dri_datepalm        .or.                              &
                i == nirrig_dri_foddergrass     .or.                              &
                i == nirrig_dri_grapes          .or. i == nirrig_dri_groundnuts  .or. &
                i == nirrig_dri_millet          .or.                              &
                i == nirrig_dri_oilpalm         .or.                              &
                i == nirrig_dri_potatoes        .or. i == nirrig_dri_pulses      .or. &
                i == nirrig_dri_rapeseed        .or. i == nirrig_dri_rice        .or. &
                i == nirrig_dri_sorghum         .or.                              &
                i == nirrig_dri_sugarbeet       .or. i == nirrig_dri_sugarcane   .or. &
                i == nirrig_dri_sunflower       .or.                              &
                i == nirrig_dri_miscanthus      .or. i == nirrig_dri_switchgrass .or. &
                i == nirrig_dri_trp_corn        .or.                              &
                i == nirrig_dri_trp_soybean     .or. i == nc3irrig_spr               .or.                              &
                i == nirrig_spr_tmp_corn        .or.                              &
                i == nirrig_spr_swheat          .or. i == nirrig_spr_wwheat      .or. &
                i == nirrig_spr_tmp_soybean     .or.                              &
                i == nirrig_spr_barley          .or. i == nirrig_spr_wbarley     .or. &
                i == nirrig_spr_rye             .or. i == nirrig_spr_wrye        .or. &
                i == nirrig_spr_cassava         .or.                              &
                i == nirrig_spr_citrus          .or.                              &
                i == nirrig_spr_cocoa           .or. i == nirrig_spr_coffee      .or. &
                i == nirrig_spr_cotton          .or.                              &
                i == nirrig_spr_datepalm        .or.                              &
                i == nirrig_spr_foddergrass     .or.                              &
                i == nirrig_spr_grapes          .or. i == nirrig_spr_groundnuts  .or. &
                i == nirrig_spr_millet          .or.                              &
                i == nirrig_spr_oilpalm         .or.                              &
                i == nirrig_spr_potatoes        .or. i == nirrig_spr_pulses      .or. &
                i == nirrig_spr_rapeseed        .or. i == nirrig_spr_rice        .or. &
                i == nirrig_spr_sorghum         .or.                              &
                i == nirrig_spr_sugarbeet       .or. i == nirrig_spr_sugarcane   .or. &
                i == nirrig_spr_sunflower       .or.                              &
                i == nirrig_spr_miscanthus      .or. i == nirrig_spr_switchgrass .or. &
                i == nirrig_spr_trp_corn        .or.                              &
                i == nirrig_spr_trp_soybean     .or. i == nc3irrig_fld               .or.                              &
                i == nirrig_fld_tmp_corn        .or.                              &
                i == nirrig_fld_swheat          .or. i == nirrig_fld_wwheat      .or. &
                i == nirrig_fld_tmp_soybean     .or.                              &
                i == nirrig_fld_barley          .or. i == nirrig_fld_wbarley     .or. &
                i == nirrig_fld_rye             .or. i == nirrig_fld_wrye        .or. &
                i == nirrig_fld_cassava         .or.                              &
                i == nirrig_fld_citrus          .or.                              &
                i == nirrig_fld_cocoa           .or. i == nirrig_fld_coffee      .or. &
                i == nirrig_fld_cotton          .or.                              &
                i == nirrig_fld_datepalm        .or.                              &
                i == nirrig_fld_foddergrass     .or.                              &
                i == nirrig_fld_grapes          .or. i == nirrig_fld_groundnuts  .or. &
                i == nirrig_fld_millet          .or.                              &
                i == nirrig_fld_oilpalm         .or.                              &
                i == nirrig_fld_potatoes        .or. i == nirrig_fld_pulses      .or. &
                i == nirrig_fld_rapeseed        .or. i == nirrig_fld_rice        .or. &
                i == nirrig_fld_sorghum         .or.                              &
                i == nirrig_fld_sugarbeet       .or. i == nirrig_fld_sugarcane   .or. &
                i == nirrig_fld_sunflower       .or.                              &
                i == nirrig_fld_miscanthus      .or. i == nirrig_fld_switchgrass .or. &
                i == nirrig_fld_trp_corn        .or.                              &
                i == nirrig_fld_trp_soybean) )then
             ! correct
          else if ( this%irrigated(i) == 0.0_r8 )then
             ! correct
          else
			 write (iulog,*) 'i = ', i
			 write (iulog,*) 'irrigated = ', this%irrigated(i)
			 write (iulog,*) 'trim(pftname(i)) = ', trim(pftname(i)) 
