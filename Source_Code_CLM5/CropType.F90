...
!DLL -- end of mods
  ...
  subroutine CropUpdateAccVars(this, bounds, t_ref2m_patch, t_soisno_col)
    ...
    use pftconMod        , only : nswheat, nirrig_dri_swheat, nirrig_spr_swheat, nirrig_fld_swheat, pftcon
    use pftconMod        , only : nwwheat, nirrig_dri_wwheat, nirrig_spr_wwheat, nirrig_fld_wwheat
    ...
    do p = begp,endp
       if (this%croplive_patch(p)) then ! relative to planting date
          ...
          if ( (trim(this%baset_mapping) == baset_map_latvary) .and. &
             ((ivt == nswheat) .or. (ivt == nirrig_dri_swheat) .or. (ivt == nirrig_spr_swheat) .or. (ivt == nirrig_fld_swheat) .or. &
              (ivt == nsugarcane) .or. (ivt == nirrig_dri_sugarcane) .or. (ivt == nirrig_spr_sugarcane) .or. (ivt == nirrig_fld_sugarcane)) ) then
          ...
          if (ivt == nwwheat .or. ivt == nirrig_dri_wwheat .or. ivt == nirrig_spr_wwheat .or. ivt == nirrig_fld_wwheat) then
